    ...
    return (
        <div className="w-[90vw] h-[84px]  py-5 bg-gray-800 flex-col items-between justify-between flex">
            <div className="justify-between items-center flex">
              <Logo />
                <div className="text-dark_gray dark:text-light_gray text-2xl font-bold font-saira leading-loose tracking-wider">{activeBoard.title}</div>
