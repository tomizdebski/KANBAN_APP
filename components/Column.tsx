...
const Column = ({color}:{color:String}) => {
  return (
    <div className="min-w-[250px] h-[936px] pl-4 py-4 bg-light_blue dark:bg-deep_gray flex-col justify-start items-start gap-[18px] inline-flex">
      ...
      <div className="self-stretch h-[76px] p-3 bg-white dark:bg-dark_gray rounded-l flex-col justify-start items-start gap-1 flex">
